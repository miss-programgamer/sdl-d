...
/**
    ...
    See_Also:
        $(D SDL_AUDIO_BITSIZE)
        $(D SDL_AUDIO_BYTESIZE)
        $(D SDL_AUDIO_ISINT)
        $(D SDL_AUDIO_ISFLOAT)
        $(D SDL_AUDIO_ISBIGENDIAN)
        $(D SDL_AUDIO_ISLITTLEENDIAN)
        $(D SDL_AUDIO_ISSIGNED)
        $(D SDL_AUDIO_ISUNSIGNED)
*/
...
version (BigEndian) {
    enum SDL_AudioFormat SDL_AUDIO_S16 = SDL_AudioFormat.SDL_AUDIO_S16BE;
    enum SDL_AudioFormat SDL_AUDIO_S32 = SDL_AudioFormat.SDL_AUDIO_S32BE;
    enum SDL_AudioFormat SDL_AUDIO_F32 = SDL_AudioFormat.SDL_AUDIO_F32BE;
} else {
    enum SDL_AudioFormat SDL_AUDIO_S16 = SDL_AudioFormat.SDL_AUDIO_S16LE;
    enum SDL_AudioFormat SDL_AUDIO_S32 = SDL_AudioFormat.SDL_AUDIO_S32LE;
    enum SDL_AudioFormat SDL_AUDIO_F32 = SDL_AudioFormat.SDL_AUDIO_F32LE;
}
...
*/
enum SDL_AUDIO_BITSIZE(x) = ((x) & SDL_AUDIO_MASK_BITSIZE);
...
/**
    ...
    Threadsafety:
        It is safe to call this macro from any thread.
*/
enum SDL_AUDIO_BYTESIZE(x) = (SDL_AUDIO_BITSIZE(x) / 8);
...
/**
    ...
    Threadsafety:
        It is safe to call this macro from any thread.
*/
enum SDL_AUDIO_ISFLOAT(x) = ((x) & SDL_AUDIO_MASK_FLOAT);
...
/**
    ...
    Threadsafety:
        It is safe to call this macro from any thread.
*/
enum SDL_AUDIO_ISBIGENDIAN(x) = ((x) & SDL_AUDIO_MASK_BIG_ENDIAN);
...
/**
    ...
    Threadsafety:
        It is safe to call this macro from any thread.
*/
enum SDL_AUDIO_ISLITTLEENDIAN(x) = (!SDL_AUDIO_ISBIGENDIAN(x));
...
/**
    ...
    Threadsafety:
        It is safe to call this macro from any thread.
*/
enum SDL_AUDIO_ISSIGNED(x) = ((x) & SDL_AUDIO_MASK_SIGNED);
...
/**
    ...
    Threadsafety:
        It is safe to call this macro from any thread.
*/
enum SDL_AUDIO_ISINT(x) = (!SDL_AUDIO_ISFLOAT(x));
...
/**
    ...
    Threadsafety:
        It is safe to call this macro from any thread.
*/
enum SDL_AUDIO_ISUNSIGNED(x) = (!SDL_AUDIO_ISSIGNED(x));
...
/**
    ...
    Threadsafety:
        It is safe to call this macro from any thread.
*/
enum SDL_AUDIO_FRAMESIZE(x) = (SDL_AUDIO_BYTESIZE((x).format) * (x).channels);
...
/**
    ...
    See_Also:
        $(D SDL_OpenAudioDevice)
        $(D SDL_GetAudioRecordingDevices)
*/
...
/**
    ...
    See_Also:
        $(D SDL_SetAudioStreamInputChannelMap)
*/
...
/**
    ...
    See_Also:
        $(D SDL_CloseAudioDevice)
        $(D SDL_GetAudioDeviceFormat)
*/
...
/**
    ...
    See_Also:
        $(D SDL_ResumeAudioDevice)
        $(D SDL_AudioDevicePaused)
*/
...
/**
    ...
    See_Also:
        $(D SDL_BindAudioStreams)
        $(D SDL_UnbindAudioStream)
        $(D SDL_GetAudioStreamDevice)
*/
extern bool SDL_BindAudioStreams(SDL_AudioDeviceID devid, const(SDL_AudioStream*)* streams, int num_streams);
...
/**
    ...
    See_Also:
        $(D SDL_BindAudioStreams)
*/
extern void SDL_UnbindAudioStreams(const(SDL_AudioStream*)* streams, int num_streams);
...
/**
    ...
    See_Also:
        $(D SDL_PutAudioStreamData)
        $(D SDL_GetAudioStreamData)
        $(D SDL_GetAudioStreamAvailable)
        $(D SDL_FlushAudioStream)
        $(D SDL_ClearAudioStream)
        $(D SDL_SetAudioStreamFormat)
        $(D SDL_DestroyAudioStream)
*/
...
/**
    ...
    See_Also:
        $(D SDL_GetAudioStreamFormat)
        $(D SDL_SetAudioStreamFrequencyRatio)
*/
extern bool SDL_SetAudioStreamFormat(SDL_AudioStream* stream, const(SDL_AudioSpec)* src_spec, const(
...
/**
    ...
    See_Also:
        $(D SDL_GetAudioStreamFrequencyRatio)
        $(D SDL_SetAudioStreamFormat)
*/
...
/**
    ...
    See_Also:
        $(D SDL_SetAudioStreamGetCallback)
        $(D SDL_SetAudioStreamPutCallback)
*/
...
/**
    ...
    Threadsafety:
        It is safe to call this function from any thread.
*/
extern bool SDL_ConvertAudioSamples(const(SDL_AudioSpec)* src_spec, const(Uint8)* src_data, int src_len, const(
        SDL_AudioSpec)* dst_spec, Uint8** dst_data, int* dst_len);
