...
enum SDL_WindowFlags SDL_WINDOW_FULLSCREEN =           0x0000000000000001;    /**< window is in fullscreen mode */
enum SDL_WindowFlags SDL_WINDOW_OPENGL =               0x0000000000000002;    /**< window usable with OpenGL context */
enum SDL_WindowFlags SDL_WINDOW_OCCLUDED =             0x0000000000000004;    /**< window is occluded */
enum SDL_WindowFlags SDL_WINDOW_HIDDEN =               0x0000000000000008;    /**< window is neither mapped onto the desktop nor shown in the taskbar/dock/window list; SDL_ShowWindow() is required for it to become visible */
enum SDL_WindowFlags SDL_WINDOW_BORDERLESS =           0x0000000000000010;    /**< no window decoration */
enum SDL_WindowFlags SDL_WINDOW_RESIZABLE =            0x0000000000000020;    /**< window can be resized */
enum SDL_WindowFlags SDL_WINDOW_MINIMIZED =            0x0000000000000040;    /**< window is minimized */
enum SDL_WindowFlags SDL_WINDOW_MAXIMIZED =            0x0000000000000080;    /**< window is maximized */
enum SDL_WindowFlags SDL_WINDOW_MOUSE_GRABBED =        0x0000000000000100;    /**< window has grabbed mouse input */
enum SDL_WindowFlags SDL_WINDOW_INPUT_FOCUS =          0x0000000000000200;    /**< window has input focus */
enum SDL_WindowFlags SDL_WINDOW_MOUSE_FOCUS =          0x0000000000000400;    /**< window has mouse focus */
enum SDL_WindowFlags SDL_WINDOW_EXTERNAL =             0x0000000000000800;    /**< window not created by SDL */
enum SDL_WindowFlags SDL_WINDOW_MODAL =                0x0000000000001000;    /**< window is modal */
enum SDL_WindowFlags SDL_WINDOW_HIGH_PIXEL_DENSITY =   0x0000000000002000;    /**< window uses high pixel density back buffer if possible */
enum SDL_WindowFlags SDL_WINDOW_MOUSE_CAPTURE =        0x0000000000004000;    /**< window has mouse captured (unrelated to MOUSE_GRABBED) */
enum SDL_WindowFlags SDL_WINDOW_MOUSE_RELATIVE_MODE =  0x0000000000008000;    /**< window has relative mode enabled */
enum SDL_WindowFlags SDL_WINDOW_ALWAYS_ON_TOP =        0x0000000000010000;    /**< window should always be above others */
enum SDL_WindowFlags SDL_WINDOW_UTILITY =              0x0000000000020000;    /**< window should be treated as a utility window, not showing in the task bar and window list */
enum SDL_WindowFlags SDL_WINDOW_TOOLTIP =              0x0000000000040000;    /**< window should be treated as a tooltip and does not get mouse or keyboard focus, requires a parent window */
enum SDL_WindowFlags SDL_WINDOW_POPUP_MENU =           0x0000000000080000;    /**< window should be treated as a popup menu, requires a parent window */
enum SDL_WindowFlags SDL_WINDOW_KEYBOARD_GRABBED =     0x0000000000100000;    /**< window has grabbed keyboard input */
enum SDL_WindowFlags SDL_WINDOW_VULKAN =               0x0000000010000000;    /**< window usable for Vulkan surface */
enum SDL_WindowFlags SDL_WINDOW_METAL =                0x0000000020000000;    /**< window usable for Metal view */
enum SDL_WindowFlags SDL_WINDOW_TRANSPARENT =          0x0000000040000000;    /**< window with transparent buffer */
enum SDL_WindowFlags SDL_WINDOW_NOT_FOCUSABLE =        0x0000000080000000;    /**< window should not be focusable */
 ...
 * \since This datatype is available since SDL 3.2.0.
 */
alias SDL_GLProfile = Uint32;

enum SDL_GLProfile SDL_GL_CONTEXT_PROFILE_CORE =           0x0001;  /**< OpenGL Core Profile context */
enum SDL_GLProfile SDL_GL_CONTEXT_PROFILE_COMPATIBILITY =  0x0002;  /**< OpenGL Compatibility Profile context */
enum SDL_GLProfile SDL_GL_CONTEXT_PROFILE_ES =             0x0004;  /**< GLX_CONTEXT_ES2_PROFILE_BIT_EXT */
 ...
 * \since This datatype is available since SDL 3.2.0.
 */
alias SDL_GLContextFlag = Uint32;

enum SDL_GLContextFlag SDL_GL_CONTEXT_DEBUG_FLAG =              0x0001;
enum SDL_GLContextFlag SDL_GL_CONTEXT_FORWARD_COMPATIBLE_FLAG = 0x0002;
enum SDL_GLContextFlag SDL_GL_CONTEXT_ROBUST_ACCESS_FLAG =      0x0004;
enum SDL_GLContextFlag SDL_GL_CONTEXT_RESET_ISOLATION_FLAG =    0x0008;
 ...
 * \since This datatype is available since SDL 3.2.0.
 */
alias SDL_GLContextReleaseFlag = Uint32;

enum SDL_GLContextReleaseFlag SDL_GL_CONTEXT_RELEASE_BEHAVIOR_NONE =   0x0000;
enum SDL_GLContextReleaseFlag SDL_GL_CONTEXT_RELEASE_BEHAVIOR_FLUSH =  0x0001;
 ...
 * \since This datatype is available since SDL 3.2.0.
 */
alias SDL_GLContextResetNotification = Uint32;

enum SDL_GLContextResetNotification SDL_GL_CONTEXT_RESET_NO_NOTIFICATION =  0x0000;
enum SDL_GLContextResetNotification SDL_GL_CONTEXT_RESET_LOSE_CONTEXT =     0x0001;
