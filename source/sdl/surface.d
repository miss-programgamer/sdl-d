...
*/
struct SDL_Surface {
    immutable(SDL_SurfaceFlags) flags;     /**< The flags of the surface, read-only */
    immutable(SDL_PixelFormat) format;     /**< The format of the surface, read-only */
    immutable(int) w;                      /**< The width of the surface, read-only. */
    immutable(int) h;                      /**< The height of the surface, read-only. */
    immutable(int) pitch;                  /**< The distance in bytes between rows of pixels, read-only */
