...
/**
    ...
    See_Also:
        $(LINK2 https://wiki.libsdl.org/SDL3/CategoryEvents, SDL3 Events Documentation)
...
struct SDL_TextEditingCandidatesEvent {
    ...
    Uint64 timestamp; /**< In nanoseconds, populated using SDL_GetTicksNS() */
    SDL_WindowID windowID; /**< The window with keyboard focus, if any */
    const(const(char)*)* candidates; /**< The list of candidates, or NULL if there are no candidates available */
...
static assert(
    SDL_Event.sizeof == (cast(SDL_Event*) null).padding.sizeof,
    "Binary compatibility was broken for SDL_Event!"
);
