...
/**
    ...
    See_Also:
        $(LINK2 https://wiki.libsdl.org/SDL3/CategoryHints, SDL3 Hints Documentation)
...
/**
    ...
    The variable can be set to the following values:
     ...
     - $(D "0"): SDL will not handle Alt+Tab. Your application is responsible for
    handling Alt+Tab while the keyboard is grabbed.
     - $(D "1"): SDL will minimize your window when Alt+Tab is pressed (default)

    This hint can be set anytime.
*/
enum SDL_HINT_ALLOW_ALT_TAB_WHILE_GRABBED = "SDL_ALLOW_ALT_TAB_WHILE_GRABBED";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"): The application starts fresh at each launch. (default)
     - $(D "1"): The application activity can be recreated by the OS.

    This hint can be set anytime.
*/
enum SDL_HINT_ANDROID_ALLOW_RECREATE_ACTIVITY = "SDL_ANDROID_ALLOW_RECREATE_ACTIVITY";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"): Low latency audio is not enabled.
     - $(D "1"): Low latency audio is enabled. (default)

    This hint should be set before SDL audio is initialized.
*/
enum SDL_HINT_ANDROID_LOW_LATENCY_AUDIO = "SDL_ANDROID_LOW_LATENCY_AUDIO";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):    Back button will be handled as usual for system. (default)
     - $(D "1"):    Back button will be trapped, allowing you to handle the key press
...
/**
    ...
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_APP_ID = "SDL_APP_ID";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):    Controller input does not generate UI events. (default)
     - $(D "1"):    Controller input generates UI events.
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):    Remote orientation does not affect joystick axes. (default)
     - $(D "1"):    Joystick axes are based on the orientation of the remote.
...
/**
    ...
    See_Also:
        $(D SDL_HINT_AUDIO_ALSA_DEFAULT_PLAYBACK_DEVICE)
        $(D SDL_HINT_AUDIO_ALSA_DEFAULT_RECORDING_DEVICE)
*/
enum SDL_HINT_AUDIO_ALSA_DEFAULT_DEVICE = "SDL_AUDIO_ALSA_DEFAULT_DEVICE";
...
/**
    ...
    See_Also:
        $(D SDL_HINT_AUDIO_ALSA_DEFAULT_RECORDING_DEVICE)
        $(D SDL_HINT_AUDIO_ALSA_DEFAULT_DEVICE)
*/
enum SDL_HINT_AUDIO_ALSA_DEFAULT_PLAYBACK_DEVICE = "SDL_AUDIO_ALSA_DEFAULT_PLAYBACK_DEVICE";
...
/**
    ...
    See_Also:
        ...
        $(D SDL_HINT_AUDIO_ALSA_DEFAULT_DEVICE)
*/
enum SDL_HINT_AUDIO_ALSA_DEFAULT_RECORDING_DEVICE = "SDL_AUDIO_ALSA_DEFAULT_RECORDING_DEVICE";
...
/**
    ...
    The variable can be set to the following values:
     ...
     - $(D "ambient"): Use the AVAudioSessionCategoryAmbient audio category, will be
    muted by the phone mute switch (default)
     - $(D "playback"): Use the AVAudioSessionCategoryPlayback category.
...
/**
    ...
    This hint should be set before an audio device is opened.
*/
enum SDL_HINT_AUDIO_CHANNELS = "SDL_AUDIO_CHANNELS";
...
/**
    ...
    This hint should be set before an audio device is opened.
*/
enum SDL_HINT_AUDIO_DEVICE_SAMPLE_FRAMES = "SDL_AUDIO_DEVICE_SAMPLE_FRAMES";
...
/**
    ...
    This hint should be set before an audio device is opened.
*/
enum SDL_HINT_AUDIO_DISK_TIMESCALE = "SDL_AUDIO_DISK_TIMESCALE";
...
/**
    ...
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_AUDIO_DRIVER = "SDL_AUDIO_DRIVER";
...
/**
    ...
    This hint should be set before an audio device is opened.
*/
enum SDL_HINT_AUDIO_DUMMY_TIMESCALE = "SDL_AUDIO_DUMMY_TIMESCALE";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "U8"): Unsigned 8-bit audio
     - $(D "S8"): Signed 8-bit audio
     - $(D "S16LE"): Signed 16-bit little-endian audio
     - $(D "S16BE"): Signed 16-bit big-endian audio
     - $(D "S16"): Signed 16-bit native-endian audio (default)
     - $(D "S32LE"): Signed 32-bit little-endian audio
     - $(D "S32BE"): Signed 32-bit big-endian audio
     - $(D "S32"): Signed 32-bit native-endian audio
     - $(D "F32LE"): Floating point little-endian audio
     - $(D "F32BE"): Floating point big-endian audio
     - $(D "F32"): Floating point native-endian audio

    This hint should be set before an audio device is opened.
*/
enum SDL_HINT_AUDIO_FORMAT = "SDL_AUDIO_FORMAT";
...
/**
    ...
    This hint should be set before an audio device is opened.
*/
enum SDL_HINT_AUDIO_FREQUENCY = "SDL_AUDIO_FREQUENCY";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"): Audio monitor devices will be ignored. (default)
     - $(D "1"): Audio monitor devices will show up in the device list.
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"): You'll call SDL_UpdateJoysticks() manually.
     - $(D "1"): SDL will automatically call SDL_UpdateJoysticks(). (default)
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"): You'll call SDL_UpdateSensors() manually.
     - $(D "1"): SDL will automatically call SDL_UpdateSensors(). (default)
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Surfaces with a colorkey or an alpha channel are saved to a 32-bit
                BMP file with an alpha mask. SDL will use the bitmap header version 4 and
                set the alpha mask accordingly. (default)
     - $(D "1"):     Surfaces with a colorkey or an alpha channel are saved to a 32-bit
...
*/
enum SDL_HINT_CAMERA_DRIVER = "SDL_CAMERA_DRIVER";
...
*/
enum SDL_HINT_CPU_FEATURE_MASK = "SDL_CPU_FEATURE_MASK";

/**
    A variable controlling whether DirectInput should be used for controllers.

    The variable can be set to the following values:
     - $(D "0"): Disable DirectInput detection.
     - $(D "1"): Enable DirectInput detection. (default)

    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_JOYSTICK_DIRECTINPUT = "SDL_JOYSTICK_DIRECTINPUT";
...
/**
    ...
    The variable can be set to the following values:
     - $(D null): Select automatically (default, all platforms)
     - $(D "portal"): Use XDG Portals through DBus (Unix only)
     - $(D "zenity"): Use the Zenity program (Unix only)

    More options may be added in the future.

    This hint can be set anytime.
*/
enum SDL_HINT_FILE_DIALOG_DRIVER = "SDL_FILE_DIALOG_DRIVER";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):    Disable emscripten_sleep calls (if you give back browser control
                    manually or use asyncify for other purposes).
     - $(D "1"):    Enable emscripten_sleep calls. (default)
...
/**
    ...
    The variable can be one of:
     - $(D "#window"):   The javascript window object
     - $(D "#document"): The javascript document object
     - $(D "#screen"):   The javascript window.screen object
     - $(D "#canvas"):   The WebGL canvas element
     - $(D "#none"):     Don't bind anything at all
...
/**
    ...
    The variable can be set to the following values:
     - $(D "auto"):  The on-screen keyboard will be shown if there is no physical
                    keyboard attached. (default)
     - $(D "0"):     Do not show the on-screen keyboard.
     - $(D "1"):     Show the on-screen keyboard, if available.

    This hint must be set before SDL_StartTextInput() is called
*/
enum SDL_HINT_ENABLE_SCREEN_KEYBOARD = "SDL_ENABLE_SCREEN_KEYBOARD";
...
/**
    ...
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_EVDEV_DEVICES = "SDL_EVDEV_DEVICES";
...
/**
    ...
    verbose:
     - $(D "0"): Don't log any events. (default)
     - $(D "1"): Log most events (other than the really spammy ones).
     - $(D "2"): Include mouse and finger motion events.
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"): Honor the OS policy for raising windows. (default)
     - $(D "1"): Force the window to be raised, overriding any OS policy.
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_FORCE_RAISEWINDOW = "SDL_FORCE_RAISEWINDOW";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Disable 3D acceleration
     - $(D "1"):     Enable 3D acceleration, using the default renderer. (default)
     - $(D "X"):     Enable 3D acceleration, using X where X is one of the valid
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"): Sensor fusion is disabled
     - $(D "1"): Sensor fusion is enabled for all controllers that lack sensors
...
*/
enum SDL_HINT_GAMECONTROLLER_SENSOR_FUSION = "SDL_GAMECONTROLLER_SENSOR_FUSION";
...
*/
enum SDL_HINT_GDK_TEXTINPUT_DEFAULT_TEXT = "SDL_GDK_TEXTINPUT_DEFAULT_TEXT";
...
/**
    ...
    This hint should be set before calling SDL_StartTextInput()
*/
enum SDL_HINT_GDK_TEXTINPUT_DESCRIPTION = "SDL_GDK_TEXTINPUT_DESCRIPTION";
...
/**
    ...
    This hint should be set before calling SDL_StartTextInput()
*/
enum SDL_HINT_GDK_TEXTINPUT_MAX_LENGTH = "SDL_GDK_TEXTINPUT_MAX_LENGTH";
...
/**
    ...
    This hint should be set before calling SDL_StartTextInput()
*/
enum SDL_HINT_GDK_TEXTINPUT_SCOPE = "SDL_GDK_TEXTINPUT_SCOPE";
...
/**
    ...
    This hint should be set before calling SDL_StartTextInput()
*/
enum SDL_HINT_GDK_TEXTINPUT_TITLE = "SDL_GDK_TEXTINPUT_TITLE";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"): HIDAPI will not use libusb for device access.
     - $(D "1"): HIDAPI will use libusb for device access if available. (default)
    
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_HIDAPI_LIBUSB = "SDL_HIDAPI_LIBUSB";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"): HIDAPI will use libusb for all device access.
     - $(D "1"): HIDAPI will use libusb only for whitelisted devices. (default)
    
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_HIDAPI_LIBUSB_WHITELIST = "SDL_HIDAPI_LIBUSB_WHITELIST";

/**
    A variable to control whether HIDAPI uses udev for device detection.
    
    The variable can be set to the following values:
     - $(D "0"): HIDAPI will poll for device changes.
     - $(D "1"): HIDAPI will use udev for device detection. (default)
    
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_HIDAPI_UDEV = "SDL_HIDAPI_UDEV";
...
*/
enum SDL_HINT_GPU_DRIVER = "SDL_GPU_DRIVER";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"): SDL_hid_enumerate() will enumerate all HID devices.
     - $(D "1"): SDL_hid_enumerate() will only enumerate controllers. (default)
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_HIDAPI_ENUMERATE_ONLY_CONTROLLERS = "SDL_HIDAPI_ENUMERATE_ONLY_CONTROLLERS";
...
/**
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_HIDAPI_IGNORE_DEVICES = "SDL_HIDAPI_IGNORE_DEVICES";
...
/**
    ...
    items:
     ...
     - $(D "composition"):   The application handles SDL_EVENT_TEXT_EDITING events and
                        can render the composition text.
     - $(D "candidates"):    The application handles SDL_EVENT_TEXT_EDITING_CANDIDATES
                        and can render the candidate list.
    
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_IME_IMPLEMENTED_UI = "SDL_IME_IMPLEMENTED_UI";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     The indicator bar is not hidden. (default for windowed applications)
     - $(D "1"):     The indicator bar is hidden and is shown when the screen is touched
                (useful for movie playback applications).
     - $(D "2"):     The indicator bar is dim and the first swipe makes it visible and
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Disable joystick & gamecontroller input events when the application
                is in the background. (default)
     - $(D "1"):     Enable joystick & gamecontroller input events when the application
...
/**
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_JOYSTICK_ARCADESTICK_DEVICES = "SDL_JOYSTICK_ARCADESTICK_DEVICES";
...
/**
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_JOYSTICK_ARCADESTICK_DEVICES_EXCLUDED = "SDL_JOYSTICK_ARCADESTICK_DEVICES_EXCLUDED";
...
/**
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_JOYSTICK_BLACKLIST_DEVICES = "SDL_JOYSTICK_BLACKLIST_DEVICES";
...
/**
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_JOYSTICK_BLACKLIST_DEVICES_EXCLUDED = "SDL_JOYSTICK_BLACKLIST_DEVICES_EXCLUDED";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     enhanced reports are not enabled.
     - $(D "1"):     enhanced reports are enabled. (default)
     - $(D "auto"):  enhanced features are advertised to the application, but SDL
                doesn't change the controller report mode unless the application uses
                them.
    
    This hint can be enabled anytime.
*/
enum SDL_HINT_JOYSTICK_ENHANCED_REPORTS = "SDL_JOYSTICK_ENHANCED_REPORTS";
...
/**
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_JOYSTICK_FLIGHTSTICK_DEVICES = "SDL_JOYSTICK_FLIGHTSTICK_DEVICES";
...
/**
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_JOYSTICK_FLIGHTSTICK_DEVICES_EXCLUDED = "SDL_JOYSTICK_FLIGHTSTICK_DEVICES_EXCLUDED";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     GameInput is not used.
     - $(D "1"):     GameInput is used.
    
    The default is "1" on GDK platforms, and "0" otherwise.
    
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_JOYSTICK_GAMEINPUT = "SDL_JOYSTICK_GAMEINPUT";
...
/**
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_JOYSTICK_GAMECUBE_DEVICES = "SDL_JOYSTICK_GAMECUBE_DEVICES";
...
/**
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_JOYSTICK_GAMECUBE_DEVICES_EXCLUDED = "SDL_JOYSTICK_GAMECUBE_DEVICES_EXCLUDED";

/**
    A variable controlling whether the HIDAPI joystick drivers should be used.
    
    The variable can be set to the following values:
     - $(D "0"): HIDAPI drivers are not used.
     - $(D "1"): HIDAPI drivers are used. (default)
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Left and right Joy-Con controllers will not be combined and each
                will be a mini-gamepad.
     - $(D "1"):     Left and right Joy-Con controllers will be combined into a single
                controller. (default)
    
    This hint should be set before initializing joysticks and gamepads.
*/
enum SDL_HINT_JOYSTICK_HIDAPI_COMBINE_JOY_CONS = "SDL_JOYSTICK_HIDAPI_COMBINE_JOY_CONS";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     HIDAPI driver is not used.
     - $(D "1"):     HIDAPI driver is used.
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Normal rumble behavior is behavior is used. (default)
     - $(D "1"):     Proper GameCube controller rumble behavior is used.
    
    This hint can be set anytime.
*/
enum SDL_HINT_JOYSTICK_HIDAPI_GAMECUBE_RUMBLE_BRAKE = "SDL_JOYSTICK_HIDAPI_GAMECUBE_RUMBLE_BRAKE";
...
/**
    ...
    This hint should be set before initializing joysticks and gamepads.
*/
enum SDL_HINT_JOYSTICK_HIDAPI_JOY_CONS = "SDL_JOYSTICK_HIDAPI_JOY_CONS";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     home button LED is turned off
     - $(D "1"):     home button LED is turned on
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_JOYSTICK_HIDAPI_JOYCON_HOME_LED = "SDL_JOYSTICK_HIDAPI_JOYCON_HOME_LED";
...
/**
    ...
    This hint should be set before initializing joysticks and gamepads.
*/
enum SDL_HINT_JOYSTICK_HIDAPI_LUNA = "SDL_JOYSTICK_HIDAPI_LUNA";
...
/**
    ...
    This hint should be set before initializing joysticks and gamepads.
*/
enum SDL_HINT_JOYSTICK_HIDAPI_NINTENDO_CLASSIC = "SDL_JOYSTICK_HIDAPI_NINTENDO_CLASSIC";
...
/**
    ...
    This hint should be set before initializing joysticks and gamepads.
*/
enum SDL_HINT_JOYSTICK_HIDAPI_PS3 = "SDL_JOYSTICK_HIDAPI_PS3";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Sony driver (sixaxis.sys) is not used.
     - $(D "1"):     Sony driver (sixaxis.sys) is used.
    
    The default value is 0.
    
    This hint should be set before initializing joysticks and gamepads.
*/
enum SDL_HINT_JOYSTICK_HIDAPI_PS3_SIXAXIS_DRIVER = "SDL_JOYSTICK_HIDAPI_PS3_SIXAXIS_DRIVER";
...
/**
    ...
    reports are enabled.
*/
enum SDL_HINT_JOYSTICK_HIDAPI_PS4_REPORT_INTERVAL = "SDL_JOYSTICK_HIDAPI_PS4_REPORT_INTERVAL";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     player LEDs are not enabled.
     - $(D "1"):     player LEDs are enabled. (default)
*/
enum SDL_HINT_JOYSTICK_HIDAPI_PS5_PLAYER_LED = "SDL_JOYSTICK_HIDAPI_PS5_PLAYER_LED";
...
/**
    ...
    This hint should be set before initializing joysticks and gamepads.
*/
enum SDL_HINT_JOYSTICK_HIDAPI_SHIELD = "SDL_JOYSTICK_HIDAPI_SHIELD";
...
/**
    ...
    The default is the value of SDL_HINT_JOYSTICK_HIDAPI.
*/
enum SDL_HINT_JOYSTICK_HIDAPI_STADIA = "SDL_JOYSTICK_HIDAPI_STADIA";
...
/**
    ...
    The variable can be set to the following values:
     ...
     - $(D "0"):     HIDAPI driver is not used. (default)
     - $(D "1"):     HIDAPI driver is used for Steam Controllers, which requires
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Steam button LED is turned off.
     - $(D "1"):     Steam button LED is turned on.
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_JOYSTICK_HIDAPI_STEAM_HOME_LED = "SDL_JOYSTICK_HIDAPI_STEAM_HOME_LED";
...
/**
    ...
    This hint should be set before initializing joysticks and gamepads.
*/
enum SDL_HINT_JOYSTICK_HIDAPI_STEAMDECK = "SDL_JOYSTICK_HIDAPI_STEAMDECK";
...
/**
    ...
    The default is the value of SDL_HINT_JOYSTICK_HIDAPI
*/
enum SDL_HINT_JOYSTICK_HIDAPI_STEAM_HORI = "SDL_JOYSTICK_HIDAPI_STEAM_HORI";
...
/**
    ...
    The default is the value of SDL_HINT_JOYSTICK_HIDAPI
*/
enum SDL_HINT_JOYSTICK_HIDAPI_LG4FF = "SDL_JOYSTICK_HIDAPI_LG4FF";
...
/**
    ...
    The default is the value of SDL_HINT_JOYSTICK_HIDAPI
*/
enum SDL_HINT_JOYSTICK_HIDAPI_8BITDO = "SDL_JOYSTICK_HIDAPI_8BITDO";
...
/**
    ...
    The default is the value of SDL_HINT_JOYSTICK_HIDAPI
*/
enum SDL_HINT_JOYSTICK_HIDAPI_FLYDIGI = "SDL_JOYSTICK_HIDAPI_FLYDIGI";
...
/**
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_JOYSTICK_HIDAPI_SWITCH_HOME_LED = "SDL_JOYSTICK_HIDAPI_SWITCH_HOME_LED";
...
/**
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_JOYSTICK_HIDAPI_SWITCH_PLAYER_LED = "SDL_JOYSTICK_HIDAPI_SWITCH_PLAYER_LED";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Left and right Joy-Con controllers will not be in vertical mode.
                (default)
     - $(D "1"):     Left and right Joy-Con controllers will be in vertical mode.
    
    This hint should be set before opening a Joy-Con controller.
*/
enum SDL_HINT_JOYSTICK_HIDAPI_VERTICAL_JOY_CONS = "SDL_JOYSTICK_HIDAPI_VERTICAL_JOY_CONS";
...
/**
    ...
    This hint should be set before initializing joysticks and gamepads.
*/
enum SDL_HINT_JOYSTICK_HIDAPI_WII = "SDL_JOYSTICK_HIDAPI_WII";
...
/**
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_JOYSTICK_HIDAPI_WII_PLAYER_LED = "SDL_JOYSTICK_HIDAPI_WII_PLAYER_LED";
...
/**
    ...
    This hint should be set before initializing joysticks and gamepads.
*/
enum SDL_HINT_JOYSTICK_HIDAPI_XBOX_360 = "SDL_JOYSTICK_HIDAPI_XBOX_360";
...
/**
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_JOYSTICK_HIDAPI_XBOX_360_PLAYER_LED = "SDL_JOYSTICK_HIDAPI_XBOX_360_PLAYER_LED";
...
/**
    ...
    This hint should be set before initializing joysticks and gamepads.
*/
enum SDL_HINT_JOYSTICK_HIDAPI_XBOX_360_WIRELESS = "SDL_JOYSTICK_HIDAPI_XBOX_360_WIRELESS";
...
/**
    ...
    This hint should be set before initializing joysticks and gamepads.
*/
enum SDL_HINT_JOYSTICK_HIDAPI_XBOX_ONE = "SDL_JOYSTICK_HIDAPI_XBOX_ONE";
...
/**
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_JOYSTICK_HIDAPI_XBOX_ONE_HOME_LED = "SDL_JOYSTICK_HIDAPI_XBOX_ONE_HOME_LED";
...
*/
enum SDL_HINT_JOYSTICK_HIDAPI_GIP = "SDL_JOYSTICK_HIDAPI_GIP";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Assume this is a generic controller.
     - $(D "1"):     Reset the controller to get metadata.
    ...
    \since This hint is available since SDL 3.4.0.
*/
enum SDL_HINT_JOYSTICK_HIDAPI_GIP_RESET_FOR_METADATA = "SDL_JOYSTICK_HIDAPI_GIP_RESET_FOR_METADATA";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     IOKit is not used.
     - $(D "1"):     IOKit is used. (default)
    
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_JOYSTICK_IOKIT = "SDL_JOYSTICK_IOKIT";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Use /dev/input/event* (default)
     - $(D "1"):     Use /dev/input/js*
    
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_JOYSTICK_LINUX_CLASSIC = "SDL_JOYSTICK_LINUX_CLASSIC";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Return unfiltered joystick axis values. (default)
     - $(D "1"):     Return axis values with deadzones taken into account.
    
    This hint should be set before a controller is opened.
*/
enum SDL_HINT_JOYSTICK_LINUX_DEADZONES = "SDL_JOYSTICK_LINUX_DEADZONES";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Only map hat axis inputs to digital hat outputs if the input axes
                appear to actually be digital. (default)
     - $(D "1"):     Always handle the input axes numbered ABS_HAT0X to ABS_HAT3Y as
                digital hats.
    
    This hint should be set before a controller is opened.
*/
enum SDL_HINT_JOYSTICK_LINUX_DIGITAL_HATS = "SDL_JOYSTICK_LINUX_DIGITAL_HATS";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Return digital hat values based on unfiltered input axis values.
     - $(D "1"):     Return digital hat values with deadzones on the input axes taken
                into account. (default)
    
    This hint should be set before a controller is opened.
*/
enum SDL_HINT_JOYSTICK_LINUX_HAT_DEADZONES = "SDL_JOYSTICK_LINUX_HAT_DEADZONES";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     GCController is not used.
     - $(D "1"):     GCController is used. (default)
    
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_JOYSTICK_MFI = "SDL_JOYSTICK_MFI";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     RAWINPUT drivers are not used. (default)
     - $(D "1"):     RAWINPUT drivers are used.
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     RAWINPUT driver will only use data from raw input APIs.
     - $(D "1"):     RAWINPUT driver will also pull data from XInput and
                Windows.Gaming.Input, providing better trigger axes, guide button
                presses, and rumble support for Xbox controllers. (default)
    
    This hint should be set before a gamepad is opened.
*/
enum SDL_HINT_JOYSTICK_RAWINPUT_CORRELATE_XINPUT = "SDL_JOYSTICK_RAWINPUT_CORRELATE_XINPUT";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     ROG Chakram mice do not show up as joysticks. (default)
     - $(D "1"):     ROG Chakram mice show up as joysticks.
    
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_JOYSTICK_ROG_CHAKRAM = "SDL_JOYSTICK_ROG_CHAKRAM";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     A separate thread is not used.
     - $(D "1"):     A separate thread is used for handling raw input messages. (default)
...
/**
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_JOYSTICK_THROTTLE_DEVICES = "SDL_JOYSTICK_THROTTLE_DEVICES";
...
/**
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_JOYSTICK_THROTTLE_DEVICES_EXCLUDED = "SDL_JOYSTICK_THROTTLE_DEVICES_EXCLUDED";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     WGI is not used.
     - $(D "1"):     WGI is used. (default)
    
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_JOYSTICK_WGI = "SDL_JOYSTICK_WGI";
...
/**
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_JOYSTICK_WHEEL_DEVICES = "SDL_JOYSTICK_WHEEL_DEVICES";
...
/**
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_JOYSTICK_WHEEL_DEVICES_EXCLUDED = "SDL_JOYSTICK_WHEEL_DEVICES_EXCLUDED";
...
/**
    ...
    This hint should be set before a controller is opened.
*/
enum SDL_HINT_JOYSTICK_ZERO_CENTERED_DEVICES = "SDL_JOYSTICK_ZERO_CENTERED_DEVICES";
...
*/
enum SDL_HINT_JOYSTICK_HAPTIC_AXES = "SDL_JOYSTICK_HAPTIC_AXES";
...
/**
    ...
    in events:
     ...
     - $(D "none"): Keycode options are cleared, this overrides other options.
     - $(D "hide_numpad"): The numpad keysyms will be translated into their
     ...
     - $(D "french_numbers"): The number row on French keyboards is inverted, so
      pressing the 1 key would yield the keycode SDLK_1, or '1', instead of
      SDLK_AMPERSAND, or '&'
     - $(D "latin_letters"): For keyboards using non-Latin letters, such as Russian
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_KEYCODE_OPTIONS = "SDL_KEYCODE_OPTIONS";
...
/**
    ...
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_KMSDRM_DEVICE_INDEX = "SDL_KMSDRM_DEVICE_INDEX";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     SDL will allow usage of the KMSDRM backend without DRM master.
     - $(D "1"):     SDL Will require DRM master to use the KMSDRM backend. (default)
    
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_KMSDRM_REQUIRE_DRM_MASTER = "SDL_KMSDRM_REQUIRE_DRM_MASTER";
...
/**
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_LOGGING = "SDL_LOGGING";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     The application is brought to the foreground when launched.
                (default)
     - $(D "1"):     The application may remain in the background when launched.
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Ctrl+Click does not generate a right mouse button click event.
                (default)
     - $(D "1"):     Ctrl+Click generated a right mouse button click event.
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Dispatching OpenGL context updates will block the dispatching thread
                until the main thread finishes processing. (default)
     - $(D "1"):     Dispatching OpenGL context updates will allow the dispatching thread
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_MAC_OPENGL_ASYNC_DISPATCH = "SDL_MAC_OPENGL_ASYNC_DISPATCH";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "none"):          The Option key is not remapped to Alt. (default)
     - $(D "only_left"):     Only the left Option key is remapped to Alt.
     - $(D "only_right"):    Only the right Option key is remapped to Alt.
     - $(D "both"):          Both Option keys are remapped to Alt.
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_MAC_OPTION_AS_ALT = "SDL_MAC_OPTION_AS_ALT";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     The mouse wheel events will have no momentum. (default)
     - $(D "1"):     The mouse wheel events will have momentum.
    
    This hint needs to be set before SDL_Init().
*/
enum SDL_HINT_MAC_SCROLL_MOMENTUM = "SDL_MAC_SCROLL_MOMENTUM";
...
/**
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_MAIN_CALLBACK_RATE = "SDL_MAIN_CALLBACK_RATE";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     The mouse is not captured while mouse buttons are pressed.
     - $(D "1"):     The mouse is captured while mouse buttons are pressed.
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_MOUSE_AUTO_CAPTURE = "SDL_MOUSE_AUTO_CAPTURE";
...
/**
    ...
    This hint needs to be set before SDL_Init().
*/
enum SDL_HINT_MOUSE_DEFAULT_SYSTEM_CURSOR = "SDL_MOUSE_DEFAULT_SYSTEM_CURSOR";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Attempts to warp the mouse will always be made.
     - $(D "1"):     Some mouse warps will be emulated by forcing relative mouse mode.
                (default)
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_MOUSE_EMULATE_WARP_WITH_RELATIVE = "SDL_MOUSE_EMULATE_WARP_WITH_RELATIVE";

/**
    Allow mouse click events when clicking to focus an SDL window.
    
    The variable can be set to the following values:
     - $(D "0"):     Ignore mouse clicks that activate a window. (default)
     - $(D "1"):     Generate events for mouse clicks that activate a window.
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Relative mouse mode constrains the mouse to the window.
     - $(D "1"):     Relative mouse mode constrains the mouse to the center of the
                window. (default)
    
    This hint can be set anytime.
*/
enum SDL_HINT_MOUSE_RELATIVE_MODE_CENTER = "SDL_MOUSE_RELATIVE_MODE_CENTER";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Relative mouse motion will be unscaled. (default)
     - $(D "1"):     Relative mouse motion will be scaled using the system mouse
                acceleration curve.
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_MOUSE_RELATIVE_SYSTEM_SCALE = "SDL_MOUSE_RELATIVE_SYSTEM_SCALE";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Warping the mouse will not generate a motion event in relative mode
     - $(D "1"):     Warping the mouse will generate a motion event in relative mode
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_MOUSE_RELATIVE_WARP_MOTION = "SDL_MOUSE_RELATIVE_WARP_MOTION";
...
/**
    ...
    This variable can be set to the following values:
     - $(D "0"):     The cursor will be hidden while relative mode is active (default)
     - $(D "1"):     The cursor will remain visible while relative mode is active
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_MOUSE_RELATIVE_CURSOR_VISIBLE = "SDL_MOUSE_RELATIVE_CURSOR_VISIBLE";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Mouse events will not generate touch events. 
                (default for desktop platforms)
     - $(D "1"):     Mouse events will generate touch events. 
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Allow keystrokes to go through to the console.
     - $(D "1"):     Mute keyboard input so it doesn't show up on the console. (default)
    
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_MUTE_CONSOLE_KEYBOARD = "SDL_MUTE_CONSOLE_KEYBOARD";

/**
    Tell SDL not to catch the SIGINT or SIGTERM signals on POSIX platforms.
    
    The variable can be set to the following values:
     - $(D "0"):     SDL will install a SIGINT and SIGTERM handler, and when it catches a
                signal, convert it into an SDL_EVENT_QUIT event. (default)
     - $(D "1"):     SDL will not install a signal handler at all.
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Use ES profile of OpenGL, if available. (default)
     - $(D "1"):     Load OpenGL ES library using the default library names.
...
*/
enum SDL_HINT_OPENVR_LIBRARY =              "SDL_OPENVR_LIBRARY";
...
/**
    ...
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_ORIENTATIONS = "SDL_ORIENTATIONS";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Disable poll sentinels.
     - $(D "1"):     Enable poll sentinels. (default)
    
    This hint can be set anytime.
*/
enum SDL_HINT_POLL_SENTINEL = "SDL_POLL_SENTINEL";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     SDL will not send an SDL_EVENT_QUIT event when the last window is
     ...
     - $(D "1"):     SDL will send a quit event when the last window is requesting to
                close. (default)
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_QUIT_ON_LAST_WINDOW_CLOSE = "SDL_QUIT_ON_LAST_WINDOW_CLOSE";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Thread-safety is not enabled. (default)
     - $(D "1"):     Thread-safety is enabled.
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Disable Debug Layer use. (default)
     - $(D "1"):     Enable Debug Layer use.
...
/**
    ...
    This variable can be set to the following values:
     - $(D "0"):     Disable Validation Layer use
     - $(D "1"):     Enable Validation Layer use
    
    By default, SDL does not use Vulkan Validation Layers.
*/
enum SDL_HINT_RENDER_VULKAN_DEBUG = "SDL_RENDER_VULKAN_DEBUG";

/**
    A variable controlling whether to create the GPU device in debug mode.
    
    This variable can be set to the following values:
     - $(D "0"):     Disable debug mode use (default)
     - $(D "1"):     Enable debug mode use
    
    This hint should be set before creating a renderer.
*/
enum SDL_HINT_RENDER_GPU_DEBUG = "SDL_RENDER_GPU_DEBUG";
...
/**
    ...
    This variable can be set to the following values:
     - $(D "0"):     Prefer high-performance GPU (default)
     - $(D "1"):     Prefer low-power GPU
    
    This hint should be set before creating a renderer.
*/
enum SDL_HINT_RENDER_GPU_LOW_POWER = "SDL_RENDER_GPU_LOW_POWER";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Use the default line drawing method (Bresenham's line algorithm)
     - $(D "1"):     Use the driver point API using Bresenham's line algorithm (correct,
                draws many points)
     - $(D "2"):     Use the driver line API (occasionally misses line endpoints based on
                hardware driver quirks
     - $(D "3"):     Use the driver geometry API (correct, draws thicker diagonal lines)
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Use the preferred OS device. (default)
     - $(D "1"):     Select a low power device.
    
    This hint should be set before creating a renderer.
*/
enum SDL_HINT_RENDER_METAL_PREFER_LOW_POWER_DEVICE = "SDL_RENDER_METAL_PREFER_LOW_POWER_DEVICE";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     The return key will be handled as a key event. (default)
     - $(D "1"):     The return key will hide the keyboard.
...
/**
    ...
    See_Also:
        $(D SDL_HINT_ROG_GAMEPAD_MICE_EXCLUDED)
*/
enum SDL_HINT_ROG_GAMEPAD_MICE = "SDL_ROG_GAMEPAD_MICE";
...
/**
    ...
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_ROG_GAMEPAD_MICE_EXCLUDED = "SDL_ROG_GAMEPAD_MICE_EXCLUDED";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     SDL will not call dbus_shutdown() on quit. (default)
     - $(D "1"):     SDL will call dbus_shutdown() on quit.
    
    This hint can be set anytime.
*/
enum SDL_HINT_SHUTDOWN_DBUS_ON_QUIT = "SDL_SHUTDOWN_DBUS_ON_QUIT";
...
/**
    ...
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_STORAGE_TITLE_DRIVER = "SDL_STORAGE_TITLE_DRIVER";
...
/**
    ...
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_STORAGE_USER_DRIVER = "SDL_STORAGE_USER_DRIVER";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     default platform specific behaviour
     - $(D "1"):     Force SDL_THREAD_PRIORITY_TIME_CRITICAL to a realtime scheduling
                policy
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Touch events will not generate mouse events.
     - $(D "1"):     Touch events will generate mouse events. (default)
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Trackpad will send mouse events. (default)
     - $(D "1"):     Trackpad will send touch events.
    
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_TRACKPAD_IS_TOUCH_ONLY = "SDL_TRACKPAD_IS_TOUCH_ONLY";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Remotes send enter/escape/arrow key events.
     - $(D "1"):     Remotes are available as 2 axis, 2 button joysticks. (default)
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Disable screensaver. (default)
...
/**
    ...
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_VIDEO_DISPLAY_PRIORITY = "SDL_VIDEO_DISPLAY_PRIORITY";
...
/**
    ...
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_VIDEO_DRIVER = "SDL_VIDEO_DRIVER";

/**
    A variable controlling whether the dummy video driver saves output frames.
     - $(D "0"):     Video frames are not saved to disk. (default)
     - $(D "1"):     Video frames are saved to files in the format "SDL_windowX-Y.bmp",
                where X is the window ID, and Y is the frame number.
    
    This hint can be set anytime.
*/
enum SDL_HINT_VIDEO_DUMMY_SAVE_FRAMES = "SDL_VIDEO_DUMMY_SAVE_FRAMES";

/**
    If eglGetPlatformDisplay fails, fall back to calling eglGetDisplay.
    
    The variable can be set to one of the following values:
     - $(D "0"):     Do not fall back to eglGetDisplay.
     - $(D "1"):     Fall back to eglGetDisplay if eglGetPlatformDisplay fails. (default)
    
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_VIDEO_EGL_ALLOW_GETDISPLAY_FALLBACK = "SDL_VIDEO_EGL_ALLOW_GETDISPLAY_FALLBACK";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Use platform-specific GL context creation API (GLX, WGL, CGL, etc).
                (default)
     - $(D "1"):     Use EGL
    
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_VIDEO_FORCE_EGL = "SDL_VIDEO_FORCE_EGL";
...
/**
    ...
    The variable can be set to the following values:
     ...
     - $(D "0"):     Disable Spaces support (FULLSCREEN_DESKTOP won't use them and
                SDL_WINDOW_RESIZABLE windows won't offer the "fullscreen" button on their
                titlebars).
     - $(D "1"):     Enable Spaces support (FULLSCREEN_DESKTOP will use them and
...
/**
    ...
    The variable can be set to the following values:
     ...
     - $(D "0"):     The menu will be hidden when the window is in a fullscreen space,
                and not accessible by moving the mouse to the top of the screen.
     - $(D "1"):     The menu will be accessible when the window is in a fullscreen
                space.
     - $(D "auto"):  The menu will be hidden if fullscreen mode was toggled on
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_VIDEO_MAC_FULLSCREEN_MENU_VISIBILITY = "SDL_VIDEO_MAC_FULLSCREEN_MENU_VISIBILITY";
...
/**
    ...
    The variable can be set to the following values:
     ...
     - $(D "0"):     SDL will not attempt to automatically set a matching mode on the
                destination display. If an exclusive fullscreen window is moved to a new
                display, the window will become fullscreen desktop.
     - $(D "1"):     SDL will attempt to automatically set a mode on the destination
    ...
    \since This hint is available since SDL 3.4.0.
*/
enum SDL_HINT_VIDEO_MATCH_EXCLUSIVE_MODE_ON_MOVE = "SDL_VIDEO_MATCH_EXCLUSIVE_MODE_ON_MOVE";
...
/**
    ...
    The variable can be set to the following values:
     ...
     - $(D "0"):     Fullscreen windows will not be minimized when they lose focus.
                (default)
     - $(D "1"):     Fullscreen windows are minimized when they lose focus.
...
/**
    ...
    This hint can be set anytime.
*/
enum SDL_HINT_VIDEO_OFFSCREEN_SAVE_FRAMES = "SDL_VIDEO_OFFSCREEN_SAVE_FRAMES";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Window operations are non-blocking. (default)
     - $(D "1"):     Window operations will block until completed.
    
    This hint can be set anytime.
*/
enum SDL_HINT_VIDEO_SYNC_WINDOW_OPERATIONS = "SDL_VIDEO_SYNC_WINDOW_OPERATIONS";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     libdecor use is disabled.
     - $(D "1"):     libdecor use is enabled. (default)
    
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_VIDEO_WAYLAND_ALLOW_LIBDECOR = "SDL_VIDEO_WAYLAND_ALLOW_LIBDECOR";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Video mode emulation is disabled.
     - $(D "1"):     Video mode emulation is enabled. (default)
    
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_VIDEO_WAYLAND_MODE_EMULATION = "SDL_VIDEO_WAYLAND_MODE_EMULATION";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "aspect"):    Video modes will be displayed scaled, in their proper aspect
                    ratio, with black bars.
     - $(D "stretch"):   Video modes will be scaled to fill the entire display.
                    (default)
     - $(D "none"):      Video modes will be displayed as 1:1 with no scaling.
    
    This hint should be set before creating a window.
*/
enum SDL_HINT_VIDEO_WAYLAND_MODE_SCALING = "SDL_VIDEO_WAYLAND_MODE_SCALING";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     libdecor is enabled only if server-side decorations are unavailable.
                (default)
     - $(D "1"):     libdecor is always enabled if available.
    
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_VIDEO_WAYLAND_PREFER_LIBDECOR = "SDL_VIDEO_WAYLAND_PREFER_LIBDECOR";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Windows will be scaled normally.
     - $(D "1"):     Windows will be forced to scale to achieve 1:1 output.
    
    This hint should be set before creating a window.
*/
enum SDL_HINT_VIDEO_WAYLAND_SCALE_TO_DISPLAY = "SDL_VIDEO_WAYLAND_SCALE_TO_DISPLAY";
...
/**
    ...
    The variable can be set to the following values:
     ...
     - $(D "none"):                  do not load any library, useful if you compiled 
                                ANGLE from source and included the compiler in 
                                your binaries.
...
/**
    ...
    The variable can be set to the following values:
     ...
     - $(D "0"):     Don't call XSelectInput(), assuming the native window code has done
                it already.
     - $(D "1"):     Call XSelectInput() to enable input events. (default)
    
    This hint should be set before creating a window.
    
    \since This hint is available since SDL 3.2.10.
*/
enum SDL_HINT_VIDEO_X11_EXTERNAL_WINDOW_INPUT = "SDL_VIDEO_X11_EXTERNAL_WINDOW_INPUT";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Disable _NET_WM_BYPASS_COMPOSITOR.
     - $(D "1"):     Enable _NET_WM_BYPASS_COMPOSITOR. (default)
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Disable _NET_WM_PING.
     - $(D "1"):     Enable _NET_WM_PING. (default)
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Disable DirectColor visuals.
     - $(D "1"):     Enable DirectColor visuals. (default)
    
    This hint should be set before initializing the video subsystem.
*/
enum SDL_HINT_VIDEO_X11_NODIRECTCOLOR = "SDL_VIDEO_X11_NODIRECTCOLOR";
...
/**
    ...
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_VIDEO_X11_SCALING_FACTOR = "SDL_VIDEO_X11_SCALING_FACTOR";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Disable touch on the back panel.
     - $(D "1"):     Enable touch on the back panel. (default)
    
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_VITA_ENABLE_BACK_TOUCH = "SDL_VITA_ENABLE_BACK_TOUCH";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Disable touch on the front panel.
     - $(D "1"):     Enable touch on the front panel. (default)
    
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_VITA_ENABLE_FRONT_TOUCH = "SDL_VITA_ENABLE_FRONT_TOUCH";
...
/**
    ...
    PlayStation Vita.
     - $(D "0"):     Skip PVR initialization.
     - $(D "1"):     Perform the normal PVR initialization. (default)
    
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_VITA_PVR_INIT = "SDL_VITA_PVR_INIT";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "544"):   544p (default)
     - $(D "720"):   725p for PSTV
     - $(D "1080"):  1088i for PSTV
    
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_VITA_RESOLUTION = "SDL_VITA_RESOLUTION";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Use OpenGL ES. (default)
     - $(D "1"):     Use OpenGL.
    
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_VITA_PVR_OPENGL = "SDL_VITA_PVR_OPENGL";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Only front touchpad should generate mouse events. (default)
     - $(D "1"):     Only back touchpad should generate mouse events.
     - $(D "2"):     Both touchpads should generate mouse events.
    
    This hint can be set anytime.
*/
enum SDL_HINT_VITA_TOUCH_MOUSE_DEVICE = "SDL_VITA_TOUCH_MOUSE_DEVICE";
...
*/
enum SDL_HINT_VULKAN_DISPLAY = "SDL_VULKAN_DISPLAY";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "truncate"):      Use the number of samples to truncate the wave data if the
                        fact chunk is present and valid.
     - $(D "strict"):        Like "truncate", but raise an error if the fact chunk is
                        invalid, not present for non-PCM formats, or if the data 
                        chunk doesn't have that many samples.
     - $(D "ignorezero"):    Like "truncate", but ignore fact chunk if the number of
                        samples is zero.
     - $(D "ignore"):        Ignore fact chunk entirely. (default)
...
/**
    ...
    This hint should be set before calling SDL_LoadWAV() or SDL_LoadWAV_IO()
*/
enum SDL_HINT_WAVE_CHUNK_LIMIT = "SDL_WAVE_CHUNK_LIMIT";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "force"):         Always use the RIFF chunk size as a boundary for the chunk
                        search.
     - $(D "ignorezero"):    Like "force", but a zero size searches up to 4 GiB.
                        (default)
     - $(D "ignore"):        Ignore the RIFF chunk size and always search up to 4 GiB.
     - $(D "maximum"):       Search for chunks until the end of file. (not recommended)
...
/**
    ...
    The variable can be set to the following values:
     - $(D "verystrict"):    Raise an error if the file is truncated.
     - $(D "strict"):        Like "verystrict", but the size of the RIFF chunk is ignored.
     - $(D "dropframe"):     Decode until the first incomplete sample frame.
     - $(D "dropblock"):     Decode until the first incomplete block. (default)
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     The window is not activated when the SDL_RaiseWindow function is
                called.
     - $(D "1"):     The window is activated when the SDL_RaiseWindow function is called.
                (default)
    
    This hint can be set anytime.
*/
enum SDL_HINT_WINDOW_ACTIVATE_WHEN_RAISED = "SDL_WINDOW_ACTIVATE_WHEN_RAISED";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     The window is not activated when the SDL_ShowWindow function is
                called.
     - $(D "1"):     The window is activated when the SDL_ShowWindow function is called.
                (default)
    
    This hint can be set anytime.
*/
enum SDL_HINT_WINDOW_ACTIVATE_WHEN_SHOWN = "SDL_WINDOW_ACTIVATE_WHEN_SHOWN";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Don't allow topmost
     - $(D "1"):     Allow topmost (default)
    
    This hint can be set anytime.
*/
enum SDL_HINT_WINDOW_ALLOW_TOPMOST = "SDL_WINDOW_ALLOW_TOPMOST";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     The window frame is not interactive when the cursor is hidden 
                (no move, resize, etc).
     - $(D "1"):     The window frame is interactive when the cursor is hidden.
                (default)
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     SDL will only do normal key handling for Alt+F4.
     - $(D "1"):     SDL will generate a window-close event when it sees Alt+F4.
                (default)
    
    This hint can be set anytime.
*/
enum SDL_HINT_WINDOWS_CLOSE_ON_ALT_F4 = "SDL_WINDOWS_CLOSE_ON_ALT_F4";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Alt+mnemonic does nothing, no beeping. (default)
     - $(D "1"):     Alt+mnemonic opens menus, invalid mnemonics produce a beep.
    
    This hint can be set anytime.
*/
enum SDL_HINT_WINDOWS_ENABLE_MENU_MNEMONICS = "SDL_WINDOWS_ENABLE_MENU_MNEMONICS";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     The window message loop is not run.
     - $(D "1"):     The window message loop is processed in SDL_PumpEvents().
                (default)
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     GameInput is not used for raw keyboard and mouse events.
     - $(D "1"):     GameInput is used for raw keyboard and mouse events, 
                if available. (default)
    
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_WINDOWS_GAMEINPUT =   "SDL_WINDOWS_GAMEINPUT";

/**
    A variable controlling whether raw keyboard events are used on Windows.
    
    The variable can be set to the following values:
     - $(D "0"):     The Windows message loop is used for keyboard events.
                (default)
     - $(D "1"):     Low latency raw keyboard events are used.
    
    This hint can be set anytime.
*/
enum SDL_HINT_WINDOWS_RAW_KEYBOARD = "SDL_WINDOWS_RAW_KEYBOARD";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Use Atomics and WaitOnAddress API when available, otherwise 
                fall back to Kernel Objects. (default)
     - $(D "1"):     Force the use of Kernel Objects in all cases.
    
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_WINDOWS_FORCE_SEMAPHORE_KERNEL = "SDL_WINDOWS_FORCE_SEMAPHORE_KERNEL";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Use the original Direct3D 9 API. (default)
     - $(D "1"):     Use the Direct3D 9Ex API on Vista and later (and fall back if D3D9Ex
                is unavailable)
    
    This hint should be set before SDL is initialized.
*/
enum SDL_HINT_WINDOWS_USE_D3D9EX = "SDL_WINDOWS_USE_D3D9EX";
...
/**
    ...
    This hint should be set before creating a window.
*/
enum SDL_HINT_WINDOWS_ERASE_BACKGROUND_MODE = "SDL_WINDOWS_ERASE_BACKGROUND_MODE";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Do not mark the window as override-redirect. (default)
     - $(D "1"):     Mark the window as override-redirect.
    
    This hint should be set before creating a window.
*/
enum SDL_HINT_X11_FORCE_OVERRIDE_REDIRECT = "SDL_X11_FORCE_OVERRIDE_REDIRECT";
...
/**
    ...
    This hint should be set before creating a window.
*/
enum SDL_HINT_X11_WINDOW_TYPE = "SDL_X11_WINDOW_TYPE";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     XInput is not enabled.
     - $(D "1"):     XInput is enabled. (default)
...
/**
    ...
    The variable can be set to the following case-sensitive values:
     - $(D "abort"):            Program terminates immediately.
     - $(D "break"):            Program triggers a debugger breakpoint.
     - $(D "retry"):            Program reruns the SDL_assert's test again.
     - $(D "ignore"):           Program continues on, ignoring this assertion failure 
                                this time.
     - $(D "always_ignore"):    Program continues on, ignoring this assertion failure
    ...
    changed at any time.
*/
enum SDL_HINT_ASSERT = "SDL_ASSERT";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Pen events will not generate mouse events.
     - $(D "1"):     Pen events will generate mouse events. (default)
    
    This hint can be set anytime.
*/
enum SDL_HINT_PEN_MOUSE_EVENTS = "SDL_PEN_MOUSE_EVENTS";
...
/**
    ...
    The variable can be set to the following values:
     - $(D "0"):     Pen events will not generate touch events.
     - $(D "1"):     Pen events will generate touch events. (default)
    
    This hint can be set anytime.
*/
enum SDL_HINT_PEN_TOUCH_EVENTS = "SDL_PEN_TOUCH_EVENTS";
...
/**
    ...
    Returns:
        $(D true) on success or $(D false) on failure; call SDL_GetError() for more
        information.
...
/**
    ...
    variable, or $(D null) if the environment isn't set. 
...
/**
    ...
    Returns:
        The string value of a hint or $(D null) if the hint isn't set.
